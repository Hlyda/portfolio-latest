    ...
    >
      ...
      <div className="px-0 md:px-20">
        ...
        <p className="text-sm md:text-base lg:text-lg lg:mt-4 font-light px-4 md:px-7 pt-3 font-outfit">
          ...
          <br />
          <br />
          De la data science à la création de sites performants, je conçois des solutions efficaces, scalables et élégantes. J’interviens sur des projets IA concrets intégrant LLMs, RAG, LangChain, automatisation et gouvernance des données.
          <br />

          <br /> Je développe aussi des plateformes web sur mesure en France et à l’international.
